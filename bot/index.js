...
bot.command('mis_compras', async (ctx) => {
  ...
  try {
    ...
    ctx.reply(
      ...
      'https://forecasthub-22.preview.emergentagent.com'
    );
  } catch (error) {
...
bot.command('renovar', (ctx) => {
  ctx.reply(
    ...
    'https://forecasthub-22.preview.emergentagent.com/dashboard/client'
  );
});
...
bot.command('mi_cuenta', (ctx) => {
  ctx.reply(
    ...
    'https://forecasthub-22.preview.emergentagent.com/dashboard/client/profile'
  );
});
