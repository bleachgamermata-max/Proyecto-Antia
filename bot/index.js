...
bot.command('mis_compras', async (ctx) => {
  ...
  try {
    ...
    ctx.reply(
      ...
      'https://figma-link-reader.preview.emergentagent.com'
    );
  } catch (error) {
...
bot.command('renovar', (ctx) => {
  ctx.reply(
    ...
    'https://figma-link-reader.preview.emergentagent.com/dashboard/client'
  );
});
...
bot.command('mi_cuenta', (ctx) => {
  ctx.reply(
    ...
    'https://figma-link-reader.preview.emergentagent.com/dashboard/client/profile'
  );
});
